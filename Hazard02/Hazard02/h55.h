...
#define H55_MSG_HISTORY_SIZE_SMALL              "To make history analysis, the serie must have 11 elements minim.\n"
...
public:
	...
	bool compareSize(const H55Horizon& visitor) const {return this->mSerie6.size() > visitor.mSerie6.size();}
...
private:
    ...
    void filterByOrder(const deque<H55Horizon*>& lin , deque<H55Horizon *> &lout);
